...
#### SWD
It is quite easy to cut into black plastic sides so that wires from inside can go under metal case and add a row of two pins. You can solder wires to STM32 SWD pins like that which also gives you easy way to reflash it and also gives you 2 more generic GIPOs as the SWD functionality can be turned off at runtime.  ![SWD pins mod](stlinkv2-1.jpg)
